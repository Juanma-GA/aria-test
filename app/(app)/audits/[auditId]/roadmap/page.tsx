    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-display font-bold text-text">POC Roadmap</h1>
      ...
      {pocs.length === 0 ? (
        <div className="card p-12 text-center text-muted text-sm">
          No POCs yet.{' '}
          <button onClick={() => router.push(`/audits/${auditId}/pocs`)} className="text-blue-aria hover:underline">
            Create POCs from eligible use cases.
          </button>
        </div>
      ) : datedPocs.length === 0 ? (
        <div className="card p-12 text-center space-y-2">
          <div className="text-muted text-sm">No POCs have start/deadline dates set.</div>
          <button onClick={() => router.push(`/audits/${auditId}/pocs`)} className="text-blue-aria text-sm hover:underline">
                  ...
                  <div className="flex-shrink-0 px-4 py-3 border-r border-border flex flex-col justify-center gap-0.5" style={{ width: LABEL_W }}>
                    ...
                    <div className="text-[10px] text-muted truncate">
                      {(poc as any).useCaseId?.cuId && (
                        <span className="font-mono">{(poc as any).useCaseId.cuId}</span>
                      )}
