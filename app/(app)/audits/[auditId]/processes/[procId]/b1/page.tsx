        ...
        <div className="card p-5 space-y-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted mt-1">
              Auto-calculated from profiles below
            </p>
          </div>
      ...
      <div className="card p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-muted mt-0.5">
              People profiles involved — used for time and cost calculations in
              B3 and use cases
            </p>
          </div>
          <button
        ...
        {profiles.length === 0 ? (
          <div className="text-center py-6 text-muted text-sm">
            No profiles yet. Add profiles to enable cost and ROI calculations.
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {profiles.map((p, i) => (
                  <tr
                    key={p.id}
                    className="border-b border-border/50 hover:bg-smoke/50"
                  >
      ...
      <div className="card p-5">
        ...
        {stakeholders.length === 0 ? (
          <div className="text-center py-8 text-muted text-sm">
            No stakeholders yet. Add at least one to complete B1.
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
